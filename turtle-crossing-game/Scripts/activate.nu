...
let virtual-env = "F:\Python\Pycharm Projects\turtle-crossing-start"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "F:\Python\Pycharm Projects\turtle-crossing-start\Scripts\deactivate.nu"
